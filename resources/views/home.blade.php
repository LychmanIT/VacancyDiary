...
@section('content')
    ...
    @auth
        <div class="page-header">
            <h1>Vacancies <small>for <b>{{ Auth::user()->name }}</b> (<a href="{{ url('/logout') }}"> logout </a>, <a href="{{ url('/password/reset') }}"> reset password </a>) <a href="{{ url('/users') }}"> Users stats </a></small></h1>
            ...
            <div class="list" >
                <ul class="list-group">
                    <li class="list-group-item">
                        <span class="badge">{{$user->vacancies->count()}}</span>
                        All vacancies
                    </li>
                </ul>
            </div>
